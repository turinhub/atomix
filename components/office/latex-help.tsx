    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mb-6">
          LaTeX
          是一个专业的文档排版系统，特别适合学术论文、技术文档和数学公式的编写。
        </p>
      </div>
            ...
            <div className="bg-muted p-4 rounded-lg">
              ...
              <div className="grid grid-cols-1 gap-4 text-sm">
                <div className="space-y-2">
                  <p>
                    • 希腊字母：<code>\\alpha, \\beta, \\gamma</code>
                  </p>
                  <p>
                    • 数学运算：<code>\\sum, \\prod, \\int</code>
                  </p>
                  <p>
                    • 分数：<code>\\frac</code>
                  </p>
                  <p>
                    • 上下标：<code>^</code> 和 <code>_</code>
                  </p>
                  <p>
                    • 根号：<code>\\sqrt</code>
                  </p>
          ...
          <div className="space-y-4">
            <div className="bg-muted p-4 rounded-lg">
              ...
              <ul className="text-sm space-y-1">
                <li>
                  <kbd className="px-2 py-1 bg-background rounded">Ctrl+S</kbd>{" "}
                  - 保存文档
                </li>
                <li>
                  <kbd className="px-2 py-1 bg-background rounded">Ctrl+Z</kbd>{" "}
                  - 撤销
                </li>
                <li>
                  <kbd className="px-2 py-1 bg-background rounded">Ctrl+Y</kbd>{" "}
                  - 重做
                </li>
                <li>
                  <kbd className="px-2 py-1 bg-background rounded">Ctrl+F</kbd>{" "}
                  - 查找
                </li>
              </ul>
            </div>
