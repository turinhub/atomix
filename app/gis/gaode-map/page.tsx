          ...
          <Tabs defaultValue="intro">
            ...
            <TabsContent value="intro" className="mt-4">
              <div className="space-y-4">
                ...
                <p>
                  本实验基于高德地图服务和 AntV L7
                  地理空间数据可视化框架，展示了全球主要碳排放源的分布情况与排放量数据。通过多种可视化方式，学习者可以直观了解碳排放的地理分布特征、时间变化趋势，以及不同类型排放源的差异。
                </p>
                <p>
                  高德地图提供了准确的中国地区地理数据，特别适合展示国内的碳排放分布情况。实验支持热力图、气泡图和3D柱状图三种可视化模式，可以根据需要切换查看不同的视觉效果。同时，实验也提供了时间轴功能，可以观察2018-2022年间的碳排放变化情况。
                </p>
              </div>
            </TabsContent>
            <TabsContent value="guide" className="mt-4">
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>可视化类型选择</strong>
                    ：可选择“热力图”、“气泡图”或“3D柱状图”展示碳排放数据
                  </li>
                  <li>
                    <strong>排放源筛选</strong>
                    ：可通过筛选按钮选择显示或隐藏不同类型的排放源（工业、能源、采矿）
                  </li>
                  <li>
                    <strong>年份调整</strong>
                    ：通过滑块可以调整查看不同年份的碳排放数据
                  </li>
                  <li>
                    <strong>地图交互</strong>
                    ：可以通过鼠标拖拽平移地图，滚轮缩放，右键旋转（3D模式下）
                  </li>
                  <li>
                    <strong>数据查看</strong>：鼠标悬停在排放源上可查看详细信息
                  </li>
                  <li>
                    <strong>热力图模式</strong>
                    ：展示碳排放密度分布，颜色越深表示排放浓度越高
                  </li>
                  <li>
                    <strong>气泡图模式</strong>
                    ：用圆圈大小表示排放量，便于比较不同地点的排放差异
                  </li>
                  <li>
                    <strong>3D柱状图模式</strong>
                    ：立体展示排放量高度，提供更直观的视觉效果
                  </li>
                </ul>
              </div>
            </TabsContent>
            <TabsContent value="theory" className="mt-4">
              <div className="space-y-4">
                ...
                <p>
                  碳排放的空间分析是研究碳排放地理分布特征、区域差异以及空间关联性的重要方法。通过空间可视化技术，可以直观展示碳排放的“热点”区域，揭示碳排放的空间聚集效应，为区域碳减排政策的制定提供科学依据。
                </p>
                <p>碳排放的空间分布受多种因素影响，包括：</p>
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>经济发展水平</strong>
                    ：经济发达地区通常碳排放总量较高
                  </li>
                  <li>
                    <strong>产业结构</strong>：重工业密集地区碳排放强度较大
                  </li>
                  <li>
                    <strong>能源结构</strong>：不同能源组合导致排放差异
                  </li>
                  <li>
                    <strong>人口密度</strong>：人口集中区域排放量较高
                  </li>
                  <li>
                    <strong>气候条件</strong>：影响能源消费和碳排放
                  </li>
                </ul>
                <p>
                  高德地图的精确定位服务，特别适合进行中国地区的碳排放空间分析，可以准确识别碳排放的空间模式，包括“热点”区域、“冷点”区域以及空间转移趋势，为精准减排提供支持。
                </p>
              </div>
            </TabsContent>
          </Tabs>
