              ...
              <div className="w-full md:w-1/3">
                ...
                <div className="flex gap-2 mt-2">
                  <Button
                    size="sm"
                    variant={
                      filteredTypes.includes("高频") ? "default" : "outline"
                    }
                  ...
                  <Button
                    size="sm"
                    variant={
                      filteredTypes.includes("中频") ? "default" : "outline"
                    }
                  ...
                  <Button
                    size="sm"
                    variant={
                      filteredTypes.includes("国际") ? "default" : "outline"
                    }
              ...
              <div>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      使用 CSV
                      格式存储起点和终点的经纬度坐标，支持附加属性如连接强度、类型等。
                    </p>
                  </div>
