...
import { Scene, PointLayer, HeatmapLayer, LineLayer, PolygonLayer, ILayer } from '@antv/l7'
  ...
  useEffect(() => {
    ...
    try {
      ...
      const mapInstance = new Mapbox({
        style: MAPBOX_STYLES[mapboxStyle as keyof typeof MAPBOX_STYLES] || MAPBOX_STYLES.dark,
        center: [108.9, 34.2],
        zoom: 3,
