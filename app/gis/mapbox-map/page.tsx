...
const routeData: RouteData[] = [
  ...
  {
    name: "伦敦-柏林运输线",
    coordinates: [[-0.1278, 51.5074], [13.4050, 52.5200]],
    value: 90,
    type: "运输"
  }
]
...
const areaData: AreaData[] = [
  ...
  {
    name: "华东工业区",
    coordinates: [[[119, 30], [122, 30], [122, 33], [119, 33], [119, 30]]],
    value: 480,
    type: "工业区"
  },
  {
    name: "五大湖工业区",
    coordinates: [[[-84, 41], [-82, 41], [-82, 43], [-84, 43], [-84, 41]]],
    value: 450,
    type: "工业区"
  }
]
              ...
              <div className="w-full md:w-1/2">
                ...
                <Select value={mapboxStyle} onValueChange={setMapboxStyle}>
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="satellite-streets">卫星街道混合</SelectItem>
                    <SelectItem value="navigation-day">导航（日间）</SelectItem>
                    <SelectItem value="navigation-night">导航（夜间）</SelectItem>
                  </SelectContent>
                </Select>
              </div>
          ...
          <Tabs defaultValue="intro">
            ...
            <TabsContent value="intro" className="mt-4">
              <div className="space-y-4">
                <h3 className="text-lg font-medium">Mapbox 地理数据可视化实验简介</h3>
                <p>本实验基于 Mapbox 地图服务和 AntV L7 地理空间数据可视化框架，提供了丰富的地图样式选择和多样化的数据可视化类型。相比传统地图，Mapbox 提供了更加精美的视觉效果和更强的定制化能力。</p>
                <p>实验支持多种 Mapbox 官方样式，包括街道、户外、卫星、导航等不同主题。同时提供了点图层、热力图、3D 柱状图、路径图、区域图和聚类图等六种可视化方式，满足不同场景的数据分析需求。</p>
              </div>
            </TabsContent>
            <TabsContent value="guide" className="mt-4">
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li><strong>Mapbox 样式选择</strong>：支持 8 种官方样式，包括街道、户外、亮色、暗色、卫星、卫星街道混合、导航日间和导航夜间</li>
                  <li><strong>可视化类型切换</strong>：
                  ...
                  <li><strong>数据筛选</strong>：通过类型按钮筛选显示不同类别的数据</li>
                  <li><strong>时间轴</strong>：拖动滑块查看不同年份的数据变化</li>
                  <li><strong>地图交互</strong>：支持缩放、平移、倾斜（3D 模式下）等操作</li>
                </ul>
              </div>
            </TabsContent>
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 border rounded-lg">
                    ...
                    <p className="text-sm text-gray-600">8 种官方精美样式，支持不同使用场景和视觉偏好</p>
                  </div>
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-medium mb-2">📊 多样化可视化</h4>
                    <p className="text-sm text-gray-600">6 种可视化类型，包括传统图表和创新的路径、区域、聚类图</p>
                  </div>
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-medium mb-2">🌍 全球高精度数据</h4>
                    <p className="text-sm text-gray-600">基于 Mapbox 全球高精度地图数据，支持任意缩放级别</p>
                  </div>
                  <div className="p-4 border rounded-lg">
                    <h4 className="font-medium mb-2">⚡ 高性能渲染</h4>
                    <p className="text-sm text-gray-600">WebGL 加速渲染，支持大规模数据的流畅交互</p>
                  </div>
                </div>
              </div>
            </TabsContent>
