      ...
      <div className="container mx-auto p-4">
        <div className="mb-4">
          ...
          <p className="text-muted-foreground">
            支持实时预览的专业 Markdown 编辑器，适用于技术文档、笔记、博客等内容创作
          </p>
        </div>
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-2">
              ...
              <div className="p-4 bg-muted/50 rounded-lg">
                ...
                <ul className="text-sm space-y-1">
                  ...
                  <li>• <code className="bg-background px-1 rounded">Ctrl + B</code> 粗体</li>
                  <li>• <code className="bg-background px-1 rounded">Ctrl + I</code> 斜体</li>
                  <li>• <code className="bg-background px-1 rounded">Ctrl + K</code> 插入链接</li>
